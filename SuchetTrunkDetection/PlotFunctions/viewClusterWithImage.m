function viewClusterWithImage(x,y, xyClass, dataPath, xStart)
% function viewClusterWithImage(x,y, xyClass, dataPath)
...
for i = 1:length(uniqueClasses)
    ...
    if meanX < xStart
        ...
        if exist(laserToImageFile)
            ...
            trunkij = round(d(:,[4 5]));
            ClassificationRateImageMask(img, trunkij, classifiedImgPath,fh_img);
