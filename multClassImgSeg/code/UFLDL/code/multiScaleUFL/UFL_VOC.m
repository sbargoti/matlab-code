function [theta, meanPatch ,ZCAWhite] = UFL_VOC(resizeF, patchsize, imageChannels, inputSize, hiddenSizeL1, sparsityParam, lambda, beta, epsilon, numPatches)
...
patches = sampleIMAGESVOC(resizeF, patchsize, imageChannels, numpatches);
