function [theta, meanPatch ,ZCAWhite] = UFL(trainData, resizeF, patchsize, inputSize, hiddenSizeL1, sparsityParam, lambda, beta, epsilon, numPatches)
...
%         trainDataResize(:,:,:,iImage) = imresize(trainData(:,:,:,iImage), resizeF);
        trainDataResize(:,:,:,iImage) = imresize(trainData(:,:,:,iImage), resizeF,'bicubic');
