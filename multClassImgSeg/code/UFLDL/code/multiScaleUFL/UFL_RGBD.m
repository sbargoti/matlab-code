function [theta, meanPatch ,ZCAWhite] = UFL_RGBD(imgList, dataPath, nband, resizeF, patchsize, inputSize, hiddenSizeL1, sparsityParam, lambda, beta, epsilon, numPatches)
...
patches = sampleRGBDIMAGESperFrame(imgList, dataPath, resizeF, nband, patchsize, numPatches);
