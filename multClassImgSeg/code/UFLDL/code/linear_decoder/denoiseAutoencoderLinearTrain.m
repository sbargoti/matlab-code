function [sparseAutoencoderLinearModel] = denoiseAutoencoderLinearTrain(visibleSize, hiddenSize, ...
                                             lambda, sparsityParam, beta, data, noiseLevel, theta)
...
corruptData = data;
corruptData(noiseIdx) = 0;

[opttheta, cost] = minFunc( @(p) denoiseAutoencoderLinearCost(p, ...
                                   visibleSize, hiddenSize, ...
                                   lambda, sparsityParam, ...
                                   beta, data, corruptData), ...
                              theta, options);
