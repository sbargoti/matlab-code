function patches = sampleIMAGESHSV(resizeF, patchsize, imageChannels, numpatches, imagePath, fileName)
...
for i = 1:length(fileName)
    ...
    [currentImage] = loadHSVImage(imagePath, fileName, resizeF);
...
function [currentImage] = loadHSVImage(imagePath, fileName, resizeF)
