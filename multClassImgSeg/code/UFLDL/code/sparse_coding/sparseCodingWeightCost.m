...
%                   otherwise.
    ...
    L1norm = lambda*sqrt(sum(sum(s*s')) + epsilon); % related to feature
    wegithDecay  = gamma* sum(sum(A.^2));           % related to weight
        
    cost =  reconsErr + wegithDecay; 
%     cost =  reconsErr; 
%     cost =   wegithDecay; 
