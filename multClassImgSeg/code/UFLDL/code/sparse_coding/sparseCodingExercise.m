...
% addpath( [rootPath 'linear_decoder'])
addpath( [rootPath 'displayNetwork'])
% addpath( [rootPath 'softmax'])
% addpath( [rootPath 'stl'])
% addpath( [rootPath 'dataSet\stl10_patches_100k']) % mnist digit data set
% addpath( [rootPath 'dataSet\stlSubset']) % mnist digit data set
addpath( [rootPath 'dataSet']) % small fast test data set and load image
% functions
...
%  Implement sparse5CodingWeightCost in sparseCodingWeightCost.m and check
%  the gradient
