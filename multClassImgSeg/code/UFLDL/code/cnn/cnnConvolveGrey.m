function convolvedFeatures = cnnConvolveGrey(patchDim, numFeatures, images, W, b, ZCAWhite, meanPatch, CNNmethod)
...
for imageNum = 1:numImages
  for featureNum = 1:numFeatures
    ...
    currentFeature = reshape(Wprep(featureNum,:),[patchDim patchDim]);
    for channel = 1
